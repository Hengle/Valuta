...
public class CardList : MonoBehaviour {
    ...
    public static List<CardState> GetLifeCards() {
        ...
        ccount.card = NormalLifeCard();
        ccount.card.cardName += "９";
        ccount.card.SetEffect(EffectPlayType.playEffect, EffectType.CardDraw, 1);
        ccount.count = 1;
        ccount.card.text = "山札からカードを１枚引く。";
        ccount.card.cardSprite = Resources.Load<Sprite>(CardSprits.Life);
        cards.Add(ccount);

        ccount = new cardCount();
        ccount.card = NormalLifeCard();
        ccount.card.cardName += "８";
        ...
        ccount.count = 1;
        ccount.card.text = "マナ＋３";
        ccount.card.cardSprite = Resources.Load<Sprite>(CardSprits.Life);
        cards.Add(ccount);

        ccount = new cardCount();
        ccount.card = NormalLifeCard();
        ccount.card.cardName += "７";
        ...
        ccount.count = 1;
        ccount.card.text = "攻撃力＋２";
        ccount.card.cardSprite = Resources.Load<Sprite>(CardSprits.Life);
        cards.Add(ccount);

        ccount = new cardCount();
        ccount.card = NormalLifeCard();
        ccount.card.cardName += "６";
        ...
        ccount.count = 1;
        ccount.card.text = "マナ＋５";
        ccount.card.cardSprite = Resources.Load<Sprite>(CardSprits.Life);
        cards.Add(ccount);

        ccount = new cardCount();
        ccount.card = NormalLifeCard();
        ccount.card.cardName += "４";
        ...
        ccount.count = 1;
        ccount.card.text = "ライフ＋１(回復後の効果は発動しない)";
        ccount.card.cardSprite = Resources.Load<Sprite>(CardSprits.Life);
        cards.Add(ccount);

        ccount = new cardCount();
        ccount.card = NormalLifeCard();
        ccount.card.cardName += "３";
        ...
        ccount.count = 1;
        ccount.card.text = "相手の全ユニットとプレイヤーに３ダメージ";
        ccount.card.cardSprite = Resources.Load<Sprite>(CardSprits.Life);
        cards.Add(ccount);
